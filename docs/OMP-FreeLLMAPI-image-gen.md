...
This setup keeps every image call extremely cheap in tokens, forces structure lock, and teaches OMP exactly how FreeLLMAPI image generation behaves (routing, free capacity, b64 output, QA loop).

Want me to also give you:

- A complete ready-to-paste `skills/image-gen/SKILL.md`
- Or the matching short prompt for your first 2–3 stages once you share the scene descriptions?
