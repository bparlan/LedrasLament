#!/usr/bin/env python3
"""
Ledras Lament Scene Generator - Working version with proper image saving
Generates images for scenes 5 and 8 using fal.ai API and saves them to disk
with version tracking to prevent overwrites.
"""
